            ...
            <div className = "container">
                <div className = "row">
                    <div className = "column left">
                        ...
                        <p className='blurb'> Some stuff I've done over the last decade that I think is interesting/relevant to whomever has received this link.</p>
                        <h3 className='year'>2013-2023</h3>
